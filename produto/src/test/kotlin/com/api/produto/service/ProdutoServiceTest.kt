...
class ProdutoServiceTest {
    ...
    fun `test list all produto`(){
        ...
        every { produtoService.listAllProdutos(Pageable.ofSize(1)) } returns Page.empty()//(ProdutoBuild.produto("9001"),ProdutoBuild.produto("9002"))

       assert(produtoService.listAllProdutos(Pageable.ofSize(1)).size == 2)
       assert(produtoService.listAllProdutos(Pageable.ofSize(1)).first().codigo == "9001")
       assert(produtoService.listAllProdutos(Pageable.ofSize(1)).last().codigo == "9002")
