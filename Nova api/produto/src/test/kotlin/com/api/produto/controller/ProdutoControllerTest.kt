...
class ProdutoControllerTest {
    ...
    fun `test find all list produtos`(){
        ...
        val pages :Page<Produto> = PageImpl<Produto>(listOf(ProdutoBuild.produto("1001"), ProdutoBuild.produto("1002")))
        every { produtoRepository.findAll(PageRequest.of(0,2, Sort.unsorted())) }  returns pages
        ...
        mockMvc.perform(get(URL_PRODUTO)
                ...
                .andExpect(jsonPath("$.content[0].codigo").value("1001"))
                .andExpect(jsonPath("$.content[1].codigo").value("1002"))
